  ...
  return (
      ...
      <ul className="menu-list">
        <li className="menu-item item-parent">
          <FontAwesomeIcon icon={faUserCircle} color="orange"/>Tài khoản của tôi
        ...
        <li className="menu-item"><a className="menu-item__link" href="/account/purchase"><FontAwesomeIcon icon={faBook} color="orange"/>Đơn mua</a></li>
      </ul>
    </div>
